...
form.addEventListener("input", (0, _lodashThrottleDefault.default)(savingData, 500));
function savingData(event) {
    event.target.type === "email" && (obj.email = event.target.value);
    event.target.name === "message" && (obj.text = event.target.value);
